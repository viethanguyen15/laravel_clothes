									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<a onclick="return del()" href="/admin/user/delete/{{$row->id}}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
											</td>
                                        </tr>
										@endforeach
...
@section('script')
	...
	<script>
		function del() 
		{
			return confirm('ban muon xoa thanh vien nay ?');	
		}
	</script>
@endsection
